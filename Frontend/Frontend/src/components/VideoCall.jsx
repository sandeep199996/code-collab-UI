...
const VideoCall = ({ activeRoomId }) => {
    ...
    useEffect(() => {
        ...
        const client = new Client({
            ...
            onConnect: () => {
                // Locked down to the private room
    ...
    return (
        // NEW: Added resize: 'both' and overflow: 'hidden' to make the container draggable!
        <div style={{ margin: '0 auto', padding: '20px', border: '1px solid #333', borderRadius: '8px', backgroundColor: '#022D36', resize: 'both', overflow: 'hidden', minWidth: '300px', minHeight: '300px', maxWidth: '1000px' }}>
            <h2 align='center' style={{ color: 'white', marginTop: 0 }}>Mentorship Video Call</h2>

            <div style={{ display: 'flex', gap: '20px', marginBottom: '15px', height: 'calc(100% - 100px)' }}>
                <div style={{ flex: 1, backgroundColor: 'black', borderRadius: '8px', overflow: 'hidden', height: '100%' }}>
                    <video ref={remoteVideoRef} autoPlay playsInline style={{ width: '100%', height: '100%', objectFit: 'cover' }} />
                </div>
                <div style={{ width: '30%', minWidth: '120px', backgroundColor: 'black', borderRadius: '8px', overflow: 'hidden', height: '100%' }}>
            ...
            {!activeRoomId ? (
                ...
                <div style={{ textAlign: 'center' }}>
                    <button onClick={startCall} style={{ padding: '10px 20px', backgroundColor: '#39FF14', color: 'black', fontWeight: 'bold', border: 'none', borderRadius: '5px', cursor: 'pointer' }}>Start Secure Call</button>
                </div>
            ) : (
